...
public class SportRepository {
    ...
    public void getMatches(final RepositoryCallback<List<Match>> callback, boolean isSecondary) {
        Callback<MatchResponse> responseCallback = new Callback<MatchResponse>() {
            @Override
        ...
        if (isSecondary) {
            api.getLiveMatchesVeboTV().enqueue(responseCallback);
        } else {
            api.getLiveMatchesThapcamTV().enqueue(responseCallback);
        }
    }
