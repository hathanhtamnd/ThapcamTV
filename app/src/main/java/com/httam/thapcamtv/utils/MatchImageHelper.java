package com.httam.thapcamtv.utils;
...
import com.httam.thapcamtv.models.Channel;
import com.httam.thapcamtv.models.Group;
...
public class MatchImageHelper {
    ...
    public static String findMatchImage(String matchTitle, String defaultImage) {
        try {
            SportApi sportApi = RetrofitClient.getClient(false).create(SportApi.class);
